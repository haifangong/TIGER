...
| Key | Value |
|-----|-------|
| `name` | `sim0p3_bin1p0_self_sgh` |
| `feature_modalities` | `gsh` |
| `fusion` | `attention` |
| `fusion_attn_mode` | `self_sgh` |
...
- **log10MAE:** 0.4363
- **RSE:** 0.5228
- **selection_score** (lower better): 0.7936
...
Copied from `outputs_code_struct_s_sim_bin_qkv/struct_s_grid__sim0p3_bin1p0_self_sgh`.
