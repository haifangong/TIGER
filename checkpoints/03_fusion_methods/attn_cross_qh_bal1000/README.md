...
| Key | Value |
|-----|-------|
| `name` | `sim0p3_bin1p0_cross_qh` |
| `feature_modalities` | `gsh` |
| `fusion` | `attention` |
| `fusion_attn_mode` | `cross_qh` |
...
- **log10MAE:** 0.4422
- **RSE:** 0.5330
- **selection_score** (lower better): 0.8425
...
Copied from `outputs_code_struct_s_sim_bin_qkv/struct_s_grid__sim0p3_bin1p0_cross_qh`.
