...
| Key | Value |
|-----|-------|
| `name` | `sim0p3_bin1p0_cross_qg` |
| `feature_modalities` | `gsh` |
| `fusion` | `attention` |
| `fusion_attn_mode` | `cross_qg` |
...
- **log10MAE:** 0.4517
- **RSE:** 0.5553
- **selection_score** (lower better): 0.9224
...
Copied from `outputs_code_struct_s_sim_bin_qkv/struct_s_grid__sim0p3_bin1p0_cross_qg`.
