...
| Key | Value |
|-----|-------|
| `name` | `signed_bin1p0_bal20000` |
| `feature_modalities` | `gsh` |
| `fusion` | `attention` |
| `fusion_attn_mode` | `cross_qs` |
| `similarity_threshold` | `0.3` |
| `pair_balance_num` | `20000` |
| `use_signed_sampling` | `True` |
| `delta_bin_width` | `1.0` |
| `seed` | `123` |
...
- **log10MAE:** 0.4350
- **RSE:** 0.5113
- **selection_score** (lower better): 0.7656
...
Copied from `outputs_code_struct_s_binsize_grid/binsize_grid__signed_bin1p0_bal20000`.
