...
- **log10MAE:** 0.4911
- **RSE:** 0.6364
- **selection_score** (lower better): 1.2583
...
Copied from `outputs_code_struct_s_binsize_grid/binsize_grid__signed_bin1p0_bal2000`.
