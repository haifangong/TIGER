...
- **log10MAE:** 0.4569
- **RSE:** 0.5571
- **selection_score** (lower better): 0.9485
...
Copied from `outputs_code_struct_s_binsize_grid/binsize_grid__signed_bin1p0_bal8000`.
