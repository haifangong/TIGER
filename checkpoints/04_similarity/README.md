...
performance across the three thresholds.

## Question

Does requiring more similar training pairs (0.5 / 0.7 vs 0.3) help or hurt CV
...
`similarity_threshold ∈ {0.3, 0.5, 0.7}` (Needleman–Wunsch score / query length,
...
sim0p5_bal10000/
sim0p7_bal10000/
external_eval_ll37_apexgo/   # post-hoc external metrics (not a training run)
```
...
| `sim0p5_bal10000` | `outputs_code_struct_s_sim05_07_fusion/...cross_qs_sim0p5_bal10000` |
